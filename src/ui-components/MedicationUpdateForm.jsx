...
export default function MedicationUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = { ...initialValues, ...medicationRecord };
    setMedName(cleanValues.medName);
    setMedQuanitity(cleanValues.medQuanitity);
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = id ? await DataStore.query(Medication, id) : medication;
