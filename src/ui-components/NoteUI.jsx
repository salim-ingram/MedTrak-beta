...
export default function NoteUI(props) {
  const { NoteUI, overrides, ...rest } = props;
          ...
          >
            ...
            >
              <Icon
                ...
                left="0%"
                right="0%"
                {...getOverrideProps(overrides, "Vector36552720")}
              ></Icon>
            </View>
            <View
              width="24px"
            ...
            >
              <Icon
                ...
                left="20.83%"
                right="20.83%"
                {...getOverrideProps(overrides, "Vector36552722")}
              ></Icon>
            </View>
          </Flex>
        </Flex>
