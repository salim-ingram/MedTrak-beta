...
export default function UpdateMedForm(props) {
  ...
  const [
    textFieldThreeSixFourSevenTwoSevenFiveEightValue,
    setTextFieldThreeSixFourSevenTwoSevenFiveEightValue,
  ] = useStateMutationAction("");
  const buttonOnClick = useDataStoreUpdateAction({
    fields: {
      medName: textFieldTwoNineSevenSixSixNineTwoTwoValue,
      medQuanitity: textFieldTwoNineSevenSixSixNineTwoThreeValue,
      medStrength: textFieldTwoNineSevenSixSixNineTwoFourValue,
      dailyDose: textFieldThreeSixFourSevenTwoSevenFiveEightValue,
    },
    id: medication?.id,
    model: Medication,
    schema: schema,
  ...
  return (
    <Flex
      ...
      {...rest}
      {...getOverrideProps(overrides, "UpdateMedForm")}
    >
      <Flex
        gap="24px"
        direction="column"
      ...
      >
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Edit Medication29766913")}
        >
          <View
            width="24px"
            height="24px"
          ...
          <Text
            ...
            {...getOverrideProps(overrides, "Edit Medication29766916")}
          ></Text>
        </Flex>
        <Divider
          width="unset"
        ...
        >
          ...
          <TextField
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeSixFourSevenTwoSevenFiveEightValue}
            onChange={(event) => {
              setTextFieldThreeSixFourSevenTwoSevenFiveEightValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField36472758")}
          ></TextField>
        </Flex>
        <Divider
          width="unset"
