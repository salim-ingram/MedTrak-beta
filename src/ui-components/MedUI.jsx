...
export default function MedUI(props) {
  ...
  return (
    <Flex
      ...
      {...rest}
      {...getOverrideProps(overrides, "MedUI")}
    >
      <Flex
        gap="0"
        direction="column"
      ...
      >
          ...
          >
            ...
            >
              <Icon
                ...
                left="0%"
                right="0%"
                {...getOverrideProps(overrides, "Vector36583050")}
              ></Icon>
            </View>
            <View
              width="24px"
            ...
            >
              <Icon
                ...
                left="20.83%"
                right="20.83%"
                {...getOverrideProps(overrides, "Vector36583052")}
              ></Icon>
            </View>
          </Flex>
        </Flex>
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "MedInfo")}
        >
          <Flex
            gap="4px"
            direction="row"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Quantity36583039")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="Quantity:"
              {...getOverrideProps(overrides, "Quantity36583044")}
            ></Text>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "DaysLeft36583053")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="Days Left:"
              {...getOverrideProps(overrides, "DaysLeft36583054")}
            ></Text>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Strength36583056")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="Strength:"
              {...getOverrideProps(overrides, "Strength36583057")}
            ></Text>
            <Text
              fontFamily="Inter"
              fontSize="16px"
